...
class image_projection:
    ...
    def image_color_callback(self, data):
        ...
        for i in range (len(conts)):
                ...
                cv2.rectangle(image_color,(x,y),(x+w,y+h),(0,255,255), 2)# to draw a box around each contour 
                cv2.putText(image_color, str(i+1),(x,y+h),cv2.FONT_HERSHEY_SIMPLEX,0.7,(255,255,0))#count the number of contours there are
       ...
       #obtained the code from
        for c in conts:
            ...
            # print out the coordinates in the map frame
                ...
                print(' total number of grapes are', No_clusters)
